              ...
              <div className="fun-fact-style-one-items">
                <div className="fun-fact">
                  <div className="counter">
                    <div className="timer" data-to="2" data-speed="1000">
                      2
                    </div>
                ...
                <div className="fun-fact">
                  <div className="counter">
                    <div className="timer" data-to="8" data-speed="1000">
                      8
                    </div>
                    <div className="operator">+</div>
                  </div>
            ...
            <div className="col-lg-7 pl-80 pl-md-15 pl-xs-15">
              <div className="about-style-one-info">
                <p style={{ textAlign: "justify" }}>
                  ...
                  React.js, Node.js, Nest.js, MySQL, PostgreSQL, Next.js and
                  AWS, I build robust, dynamic web applications.
                </p>
                <Link
